...
public class Operator {
    ...
    public static void main(String[] args) {
        ...
        int total = 0;
// Operator aritmatika
        int hasilJumlah = angka1 + angka2; // 32
        int hasilKurang = angka1 - angka2; // 8
        int hasilKali = angka1 * angka2; // 240
        int hasilBagi = angka1 / angka2; // 1
        int hasilSisa = angka1 % angka2; // 8
...
// Operator logika
        ...
        boolean orHasil = (angka1 == 0) || (angka2 == 0); // false
        boolean notHasil = !sama; // true
// Operator penugasan   int total = 0;
        total += angka1; // total = 
